document.addEventListener('DOMContentLoaded', function() {
    ...
    var inputsToValidate = document.querySelectorAll('#email, #katasandi, #konfirmasikatsan, #namauser, #alamat, #notelp');
    ...
    form.addEventListener('submit', function(event) {
        ...
        const addrress = document.getElementById('alamat').value;
        const phoneNumber = document.getElementById('notelp').value;

        // Cek jika ada input yang kosong
        if (!email || !password || !confirmPassword || !username || !phoneNumber || !alamat) {
